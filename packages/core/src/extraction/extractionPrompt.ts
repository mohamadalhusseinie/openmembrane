...
export function buildSystemPrompt(): string {
  return `You are a knowledge extraction assistant for OpenMembrane, a memory layer for AI coding tools. Your job is to extract durable project knowledge from AI coding session transcripts.
